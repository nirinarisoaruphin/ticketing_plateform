-- ============================================================
-- TICKETING PLATEFORME - SCRIPT SQL COMPLET
-- ============================================================
-- Ce script regroupe TOUTES les requêtes nécessaires pour
-- créer la base de données depuis zéro :
--   - sql/database.sql (schéma de base)
--   - sql/intervention.sql (colonnes actual_start/actual_end/actual_duration)
--   - sql/maj_utilisateur.sql (colonnes last_activity_at, user_agent)
--   - sql/migration_ticket_sequences.sql (compteur atomique tickets)
--   - sql/whatsapp.sql (tables whatsapp_queue, whatsapp_images)
--
-- À exécuter EN UNE SEULE FOIS sur une base vide (ou existante,
-- les tables sont recréées avec DROP TABLE IF EXISTS).
-- ============================================================
...
-- Inclut actual_start / actual_duration / actual_end
-- (fusion avec sql/intervention.sql)
-- ============================================
...
-- Inclut user_agent (fusion avec sql/maj_utilisateur.sql)
-- ============================================
...
-- ============================================
-- 12. TABLE `ticket_sequences`
-- Compteur atomique pour générer les numéros de ticket
-- sans risque de doublon (fusion avec
-- sql/migration_ticket_sequences.sql)
-- ============================================
...
-- ============================================
-- 13. TABLE `whatsapp_queue`
-- (fusion avec sql/whatsapp.sql)
-- ============================================
...
-- ============================================
-- 15.1 Création des utilisateurs par défaut
-- Mot de passe pour tous : admin123 (hashé)
-- ============================================
...
-- CHARGÉS D'ÉTUDE
('faniry', 'faniry@spider.mg', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Faniry - Chargé d\'Étude Courant Fort', '+261 34 00 000 03', 'charge_etude_courant_fort', 0, 1, NOW()),
...
-- ============================================
-- 15.2 Exemple de ticket (optionnel)
-- ============================================
...
-- ============================================
-- 15.3 Initialiser le compteur ticket_sequences
-- pour cohérence avec le ticket exemple ci-dessus
-- (support_technique -> TK-ST, année 2026, prochain = 1)
-- ============================================

INSERT INTO `ticket_sequences` (`category_prefix`, `year`, `next_number`) VALUES
('TK-ST', 2026, 1);

-- ============================================
-- 15.4 Exemple de commentaire
-- ============================================
...
SELECT table_name FROM information_schema.tables WHERE table_schema = 'ticketing_plateform' ORDER BY table_name;
