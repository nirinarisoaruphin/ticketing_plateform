...
try {
    ...
    echo "<hr>";
    echo "<p><a href='index.php' style='color:blue;font-weight:bold;'>Accéder à l'application</a></p>";
    echo "<p style='color:red;font-weight:bold;'>Pensez à supprimer ce fichier après utilisation !</p>";
