...
class UserController {
    ...
    /**
     * Changement de mot de passe simple, réservé à l'administrateur, directement
     * depuis la page "Modifier l'utilisateur". Pas d'email, pas de code de
     * vérification : juste mot de passe actuel (le sien) + nouveau + confirmation.
     * Aucune contrainte de longueur ou de complexité sur le nouveau mot de passe.
     * Réponse JSON (appelé en AJAX).
     */
    public function changePassword() {
        ...
        // APPLIQUER LE NOUVEAU MOT DE PASSE (aucune contrainte de longueur/complexité)
        $this->userModel->update($id, [
