...
<div class="w-full px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        <div class="flex gap-2 flex-wrap">
            <a href="index.php?page=tickets&action=create" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition flex items-center shadow-sm hover:shadow-md">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50/50">
            <h2 class="text-sm font-semibold text-gray-700">
                ...
                } elseif ($role === 'charge_etude_courant_fort' || $role === 'charge_etude_courant_faible' || $role === 'charge_etude_climatisation') {
            ...
            <a href="index.php?page=tickets" class="text-sm text-green-600 hover:text-green-800 font-medium">
                Voir tout →
            </a>
        </div>
        ...
        <div class="p-8 text-center text-gray-400">
            ...
            <?php if ($role === 'commercial'): ?>
            <a href="index.php?page=tickets&action=create" class="mt-3 inline-block text-green-600 hover:text-green-800 text-sm">
                ...
                <div class="flex items-start gap-3">
                    <div class="flex-shrink-0 mt-0.5">
                        <div class="w-8 h-8 rounded-full <?= 
                            ...
                            ($activity['role'] === 'responsable_support_technique' ? 'bg-green-100 text-green-600' : 
                            ($activity['role'] === 'responsable_sav' ? 'bg-pink-100 text-pink-600' : 
                            ($activity['role'] === 'responsable_travaux' ? 'bg-amber-100 text-amber-600' : 
                            ($activity['role'] === 'charge_etude_courant_fort' || $activity['role'] === 'charge_etude_courant_faible' || $activity['role'] === 'charge_etude_climatisation' ? 'bg-emerald-100 text-emerald-600' : 
