    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form method="POST" class="p-6 space-y-5">
            ...
            <div>
                ...
                <select name="duration" class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition">
            ...
            <div>
                ...
                <select name="status" class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition">
            ...
            <div>
                ...
                <textarea name="notes" rows="3" 
                          class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition"><?= htmlspecialchars($intervention['notes'] ?? '') ?></textarea>
            </div>
            ...
            <div class="flex space-x-3 pt-4 border-t">
                ...
                <a href="index.php?page=planning" class="btn-annuler px-6 py-2.5 rounded-lg transition font-medium flex items-center gap-2">
