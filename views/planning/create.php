        ...
        <form method="POST" class="p-6 space-y-5">
            ...
            <div>
                ...
                <select name="technician_id" id="technician_id" required 
                        class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
                        disabled>
