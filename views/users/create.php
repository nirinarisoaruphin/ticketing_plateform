            ...
            <div>
                ...
                <select name="role" required class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition">
                    ...
                    <optgroup label="Chargés d'Étude">
                        <option value="charge_etude_courant_fort">Chargé d'Étude Courant Fort + Energie secouru</option>
                    ...
                    <div>
                        <div class="relative">
                            <input type="password" name="password" id="password" required 
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition pr-10"
