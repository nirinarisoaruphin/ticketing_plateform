...
<div class="w-full px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 text-center">
            <p class="text-xl font-bold text-teal-600"><?= $roleCounts['coordinateur'] ?? 0 ?></p>
            <p class="text-xs text-gray-500">Coordinateurs</p>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 text-center">
            <p class="text-xl font-bold text-green-600"><?= ($roleCounts['responsable_support_technique'] ?? 0) + ($roleCounts['responsable_sav'] ?? 0) + ($roleCounts['responsable_travaux'] ?? 0) ?></p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 text-center">
            <p class="text-xl font-bold text-emerald-600"><?= ($roleCounts['charge_etude_courant_fort'] ?? 0) + ($roleCounts['charge_etude_courant_faible'] ?? 0) + ($roleCounts['charge_etude_climatisation'] ?? 0) ?></p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="px-6 py-3 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
            ...
            <div class="flex flex-wrap gap-4 text-sm text-gray-400">
                ...
                <span><i class="fas fa-circle text-teal-500"></i> Coordinateur</span>
                <span><i class="fas fa-circle text-green-500"></i> Responsable</span>
