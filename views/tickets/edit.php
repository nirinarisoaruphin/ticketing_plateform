        ...
        <form method="POST" class="p-6 space-y-4">
            ...
            <div>
                ...
                <textarea name="elements_complement" rows="3" 
                          class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition"><?= htmlspecialchars($ticket['elements_complement'] ?? '') ?></textarea>
                <p class="text-xs text-green-600 mt-1">Ce champ peut être modifié.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <?php else: ?>
                        ...
                        <select name="assigned_to" class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition">
