    ...
    <div class="flex flex-wrap justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">
                <!--<i class="fas fa-list text-green-600 mr-2"></i>!-->Tickets
            </h1>
            <p class="text-sm text-gray-500 mt-1">
                ...
                if ($role === 'commercial') {
                    ...
                    echo ' Consultation de tous les tickets';
        ...
        <div class="flex gap-2 mt-2 sm:mt-0 flex-wrap">
            <?php if (in_array($role, ['coordinateur', 'responsable_support_technique', 'responsable_sav', 'responsable_travaux', 'charge_etude_courant_fort', 'charge_etude_courant_faible', 'charge_etude_climatisation', 'commercial'])): ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
        <form method="GET" class="flex flex-wrap gap-3 items-end">
            ...
            <div>
                ...
                <select name="status" class="mt-1 px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500 focus:border-transparent">
            ...
            <div>
                ...
                <select name="priority" class="mt-1 px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500 focus:border-transparent">
        ...
        <?php if (empty($tickets)): ?>
            <div class="p-12 text-center text-gray-500">
                ...
                if ($role === 'commercial'): ?>
                    ...
                    <a href="index.php?page=tickets&action=create" class="mt-3 inline-block text-green-600 hover:text-green-800">
                ...
                <?php elseif (in_array($role, ['charge_etude_courant_fort', 'charge_etude_courant_faible', 'charge_etude_climatisation'])): ?>
                        ...
                        <tr class="hover:bg-gray-50 transition cursor-pointer" onclick="window.location.href='index.php?page=tickets&action=show&id=<?= $ticket['id'] ?>'">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2" onclick="event.stopPropagation();">
                                <a href="index.php?page=tickets&action=show&id=<?= $ticket['id'] ?>" 
                                   class="text-green-600 hover:text-green-800 transition" title="Voir">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <?php $rowLocked = isTicketLocked($ticket); ?>
                                <?php if (in_array($role, ['coordinateur', 'responsable_support_technique', 'responsable_sav', 'responsable_travaux'])): ?>
                                    <?php if ($rowLocked): ?>
                                    <span class="is-locked text-gray-400" title="<?= htmlspecialchars(getTicketLockMessage($ticket)) ?>">
                                ...
                                <?php if ($rowLocked): ?>
                                <i class="fas fa-lock text-gray-300 ml-1" title="Ticket verrouillé"></i>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
