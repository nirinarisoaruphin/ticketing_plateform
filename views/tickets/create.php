...
$categoryResponsibleMap = [
    ...
    'charge_etude_courant_fort' => [
        ...
        'label' => 'Chargé d\'Étude Courant Fort',
...
$canCreate = in_array($role, ['admin', 'coordinateur', 'responsable_support_technique', 'responsable_sav', 'responsable_travaux', 'charge_etude_courant_fort', 'charge_etude_courant_faible', 'charge_etude_climatisation', 'commercial']);
            ...
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-xl font-bold text-gray-900">
                        <i class="fas fa-plus-circle text-green-600 mr-2"></i>Nouvelle demande
                    </h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="type_demande" id="type_demande" required 
                            ...
                            <optgroup label="Travaux" class="type-group" data-category="travaux">
                                <option value="travaux">Travaux</option>
                            </optgroup>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <input type="text" name="title" id="title" required 
                               class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition field-auto"
            ...
            <div class="wizard-step" data-step="3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="date" name="visite_date" id="visite_date" required
                                   class="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition field-auto">
                    ...
                    <div>
                        <div id="moyenTransportContainer" style="display: none;">
                            ...
                            <select name="moyen_transport" id="moyen_transport" class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="description" rows="4" required 
                              class="mt-1 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition resize-none"
                ...
                <div class="mt-4">
                    ...
                    <input type="file" name="attachment" 
                           class="mt-1 w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100 transition">
