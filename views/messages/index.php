...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_message'])) {
    ...
    if ($ticketId > 0 && !empty($content)) {
        ...
        $_SESSION['flash'] = ['type' => 'danger', 'message' => 'Veuillez remplir tous les champs.'];
    }
...
elseif (in_array($userRole, ['charge_etude_courant_fort', 'charge_etude_courant_faible', 'charge_etude_climatisation'])) {
    $conversations = $db->fetchAll("
        SELECT DISTINCT 
            t.id as ticket_id,
            t.ticket_number,
...
if ($activeTicketId > 0) {
    ...
    if ($ticket) {
        ...
        if ($userRole === 'admin' || $userRole === 'coordinateur') {
            ...
            $canAccess = true;
        } elseif (in_array($userRole, ['charge_etude_courant_fort', 'charge_etude_courant_faible', 'charge_etude_climatisation']) && $ticket['assigned_to'] == $userId) {
            $canAccess = true;
...
<div class="messenger-container">
    ...
    <div class="messenger-sidebar">
        <div class="sidebar-header">
            <h2>
                <i class="fas fa-comment-dots" style="color:#16A34A;font-size:14px;"></i>
                Discussions
                    ...
                    <div class="msg-content">
                        ...
                        <div class="msg-footer">
                            <div class="msg-meta">
                                ...
                                <?php if ($isOwn): ?>
                                <span style="color:#16A34A;font-weight:500;">Vous</span>
                                <?php endif; ?>
...
<div class="modal-overlay" id="editModal">
    <div class="modal-box">
        <h3><i class="fas fa-edit" style="color:#16A34A;"></i> Modifier le message</h3>
        ...
        <form method="POST" action="index.php?page=messages">
            ...
            <div class="modal-actions">
                <button type="button" class="btn-cancel btn-annuler btn-annuler-sm" onclick="closeEditModal()">Annuler</button>
...
<div class="modal-overlay" id="deleteModal">
    <div class="modal-box" style="max-width: 400px;">
        ...
        <div class="modal-actions">
            <button class="btn-cancel btn-annuler btn-annuler-sm" onclick="closeDeleteModal()">Annuler</button>
