        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-3">
                <a href="index.php?page=dashboard" class="flex items-center gap-2 group">
                    <div class="w-10 h-10 bg-gradient-to-br from-green-500 to-green-700 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-all group-hover:scale-105">
            ...
            <div class="hidden md:flex items-center gap-1">
                ...
                <!-- Planning -->
                <?php if (in_array($role, ['admin', 'coordinateur', 'responsable_support_technique', 'responsable_sav', 'responsable_travaux', 'charge_etude_courant_fort', 'charge_etude_courant_faible', 'charge_etude_climatisation'])): ?>
...
function testNotification() {
    if (window.notifSystem) {
        ...
        console.warn('Système de notification non initialisé');
    }
}
</script>
