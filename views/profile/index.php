...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 page-enter">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <!-- ============================================ -->
        <div class="relative bg-gradient-to-r from-green-500 via-green-600 to-teal-600 px-6 py-8">
        ...
        <div class="p-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        ...
                        <p class="text-gray-800 font-medium mt-1">
                            <span class="badge <?= 
                                ...
                                ($user['role'] === 'coordinateur' ? 'bg-teal-100 text-teal-800' : 
                                ($user['role'] === 'responsable_support_technique' ? 'bg-green-100 text-green-800' :
                                ...
                                ($user['role'] === 'charge_etude_courant_fort' ? 'bg-orange-100 text-orange-800' :
            ...
            <div class="mt-6 grid grid-cols-2 md:grid-cols-4 gap-3">
                <div class="bg-white rounded-lg p-4 border border-gray-200 text-center hover:shadow-md transition">
                    <p class="text-2xl font-bold text-green-600"><?= $ticketsCreated['count'] ?? 0 ?></p>
...
.avatar-coordinateur { background: linear-gradient(135deg, #8B5CF6, #0D9488); }
.avatar-responsable_support_technique { background: linear-gradient(135deg, #16A34A, #15803D); }
...
.avatar-charge_etude_courant_fort { background: linear-gradient(135deg, #F97316, #EA580C); }
