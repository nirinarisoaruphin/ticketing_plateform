...
<div class="w-full px-4 sm:px-6 lg:px-8 py-8 page-enter">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 text-center hover:shadow-md transition">
            <p class="text-2xl font-bold text-green-600"><?= count($notifications) ?></p>
            <p class="text-xs text-gray-500 flex items-center justify-center gap-1">
                <i class="fas fa-bell text-green-400"></i> Notifications
            </p>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 text-center hover:shadow-md transition">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 text-center hover:shadow-md transition">
            <p class="text-2xl font-bold text-teal-600"><?= count(array_filter($activities, function($a) { return !empty($a['is_action']); })) ?></p>
            <p class="text-xs text-gray-500 flex items-center justify-center gap-1">
                <i class="fas fa-bolt text-teal-400"></i> Actions
            </p>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 text-center hover:shadow-md transition">
    ...
    <div class="flex flex-wrap gap-2 mb-6">
        <button onclick="filterNotifications('all')" class="filter-btn active px-3 py-1.5 text-sm rounded-lg bg-green-600 text-white transition" data-filter="all">
        ...
        <button onclick="filterNotifications('unread')" class="filter-btn px-3 py-1.5 text-sm rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="unread">
            <i class="fas fa-circle text-green-500 text-[8px] mr-1"></i> Non lues
        </button>
        ...
        <button onclick="filterNotifications('ticket')" class="filter-btn px-3 py-1.5 text-sm rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="ticket">
            <i class="fas fa-ticket-alt text-green-500 mr-1"></i> Tickets
        </button>
        ...
        <button onclick="filterNotifications('action')" class="filter-btn px-3 py-1.5 text-sm rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="action">
            <i class="fas fa-bolt text-teal-500 mr-1"></i> Actions
        </button>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8">
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white flex justify-between items-center">
            ...
            <div class="flex items-center gap-3">
                <?php if (!empty($notifications)): ?>
                <button onclick="markAllRead()" class="text-xs text-green-600 hover:text-green-800 font-medium transition flex items-center gap-1">
                    <i class="fas fa-check-double"></i> Tout marquer comme lu
                </button>
        ...
        <div class="divide-y divide-gray-100 max-h-[600px] overflow-y-auto custom-scroll" id="notificationList">
            ...
            ?>
            <div class="notification-item px-6 py-4 hover:bg-gray-50 transition <?= $notif['is_read'] ? '' : 'bg-green-50/30 border-l-4 border-green-500' ?>" 
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-[10px] bg-green-100 text-green-600 px-2 py-0.5 rounded-full font-medium">Nouveau</span>
                                    <?php endif; ?>
                                </div>
                            ...
                            <?php if ($notif['link']): ?>
                            <a href="<?= htmlspecialchars($notif['link']) ?>" class="text-green-600 hover:text-green-800 text-sm font-medium ml-2 flex-shrink-0 flex items-center gap-1 group">
