        ...
        <form method="GET" action="index.php?page=export" class="p-6 space-y-6">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select name="priority" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_from" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm">
                    </div>
                    
                    <!-- Date de fin -->
                    <div>
                        <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Date de fin</label>
                        <input type="date" name="date_to" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm">
                    </div>
                    
                    <!-- Assigné à -->
                    <div>
                        <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Assigné à</label>
                        <select name="assigned_to" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm">
                            <option value="">Tous</option>
                            <?php
                            $db = Database::getInstance();
                            $users = $db->fetchAll("SELECT id, full_name FROM users WHERE role IN ('responsable_support_technique', 'responsable_sav', 'responsable_travaux', 'charge_etude_courant_fort', 'charge_etude_courant_faible', 'charge_etude_climatisation') ORDER BY full_name");
            ...
            <div class="border-t border-gray-200 pt-6 flex flex-wrap gap-4 justify-between items-center">
                ...
                <div class="flex gap-3">
                    <a href="index.php?page=dashboard" class="btn-annuler px-5 py-2 rounded-lg transition font-medium">
                        Annuler
                    </a>
