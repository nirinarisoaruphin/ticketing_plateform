...
class WhatsAppImageGenerator {
    ...
    public function generateActionImage($ticket, $actionType, $senderName, $content = '') {
        ...
        // Niveau 6 au lieu de 9 : taille de fichier quasi identique pour
        // ce type d'image (aplats de couleur), mais environ 3 fois plus
        // rapide à encoder.
        imagepng($this->image, $path, 6);
    ...
    private function drawActionBanner($actionType) {
        ...
        $actionLabels = [
            ...
            'signaler_probleme' => ['label' => 'Problème signalé', 'color' => $this->colors['danger']],
