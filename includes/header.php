...
<head>
    ...
    <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><rect width='24' height='24' rx='6' fill='%2316A34A'/><path fill='%23fff' d='M6 17c6-1 10-5 11-11-6 1-10 5-11 11z'/></svg>">
    ...
    <style>
        ...
        .notification-toast .notif-icon.ticket { background: #eafaf0; color: #16A34A; }
        ...
        .notification-toast .notif-icon.action { background: #e6f7f2; color: #0D9488; }
