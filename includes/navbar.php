    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-3">
                ...
                <!-- ✅ ICÔNE TICKET VERTE (thème conservé) -->
                <div class="w-10 h-10 bg-gradient-to-br from-green-500 to-teal-700 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-all group-hover:scale-105">
