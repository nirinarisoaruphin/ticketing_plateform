...
try {
    ...
    $users = [
        ...
        ['faniry', 'faniry@spider.mg', $hashedPassword, 'Faniry - Chargé d\'Étude Courant Fort', 'charge_etude_courant_fort'],
    ...
    echo "</ul>";
    echo "<p style='color:orange;'>Tous les utilisateurs ont le même mot de passe : <strong>admin123</strong></p>";
    
    echo "<hr>";
    echo "<p><a href='index.php?page=login' style='font-size:18px;color:blue;'>Aller à la page de connexion</a></p>";
    echo "<p style='color:red;font-weight:bold;'>Pensez à supprimer ce fichier (setup_teams.php) après utilisation !</p>";
